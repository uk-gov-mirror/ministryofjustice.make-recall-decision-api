...
fun toDeliusContactOutcome(spoRecallType: String?): DeliusContactOutcome = if (spoRecallType == ManagerRecallDecisionTypeValue.NO_RECALL.name) DECISION_NOT_TO_RECALL else DECISION_TO_RECALL
