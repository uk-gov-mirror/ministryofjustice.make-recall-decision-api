...
class RecommendationConverter(
   ...
   */
  fun convert(recommendationEntity: RecommendationEntity): RecommendationResponse = RecommendationResponse(
    ...
    isRecalledOnNewChargedOrConvictedOffence = recommendationEntity.data.isRecalledOnNewChargedOrConvictedOffence,
