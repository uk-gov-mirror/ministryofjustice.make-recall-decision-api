...
class RecommendationControllerTest : IntegrationTestBase() {
  ...
  fun `update recommendation with bookRecallToPpud data`() {
    ...
    with(bookRecallToPpudAfterUpdate) {
      ...
      val ppudSentenceData = bookRecallToPpudAfterUpdate.getJSONObject("ppudSentenceData")
      assertThat(ppudSentenceData.get("offenceDescription")).isEqualTo(bookRecallToPpud.ppudSentenceData?.offenceDescription)
      assertThat(ppudSentenceData.get("releaseDate")).isEqualTo(bookRecallToPpud.ppudSentenceData?.releaseDate.toString())
      assertThat(ppudSentenceData.get("sentencingCourt")).isEqualTo(bookRecallToPpud.ppudSentenceData?.sentencingCourt)
      assertThat(ppudSentenceData.get("dateOfSentence")).isEqualTo(bookRecallToPpud.ppudSentenceData?.dateOfSentence.toString())
