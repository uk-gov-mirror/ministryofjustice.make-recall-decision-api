...
internal class VulnerabilitiesServiceTest : ServiceTestBase() {
  ...
  fun `retrieves risks and formats into vulnerabilities`() {
    runTest {
      ...
      assertThat(vulnerabilities.selfHarm?.risk).isEqualTo("Yes")
      ...
      assertThat(vulnerabilities.vulnerability?.risk).isEqualTo("Yes")
      ...
      assertThat(vulnerabilities.custody?.risk).isEqualTo("Yes")
      ...
      assertThat(vulnerabilities.hostelSetting?.risk).isEqualTo("Yes")
