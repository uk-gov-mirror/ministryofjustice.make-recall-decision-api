...
fun recommendationModel(
  ...
  wasReferredToParoleBoard244ZB: Boolean? = randomBoolean(),
  wasRepatriatedForMurder: Boolean? = randomBoolean(),
  isServingSOPCSentence: Boolean? = randomBoolean(),
  isServingDCRSentence: Boolean? = randomBoolean(),
  isYouthSentenceOver12Months: Boolean? = randomBoolean(),
  isYouthChargedWithSeriousOffence: Boolean? = randomBoolean(),
  // deprecated
  ...
  wasReferredToParoleBoard244ZB = wasReferredToParoleBoard244ZB,
  wasRepatriatedForMurder = wasRepatriatedForMurder,
  isServingSOPCSentence = isServingSOPCSentence,
  isServingDCRSentence = isServingDCRSentence,
