...
import uk.gov.justice.digital.hmpps.makerecalldecisionapi.domain.makerecalldecisions.prison.Identifier
...
class OffenderTest {
  ...
  fun `toPrisonOffender conversion - standard`() {
    val offenderInput = Offender(
      ...
      sentenceDetail = SentenceDetail(LocalDate.parse("2000-03-15"), LocalDate.parse("2025-01-01")),
    )
